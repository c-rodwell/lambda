...
def add_item(event, context):
	try:
		userId, value = json_func.get_body_args(event, {'userId':str, 'value':str})
...
def get_item(event, context):
	try:
		userId, itemId = json_func.get_querystring_args(event, {'userId':str, 'itemId':int})
		table = itemTableResource()
...
def delete_item(event, context):
	try:
		userId, itemId = json_func.get_body_args(event, {'userId':str, 'itemId':int})
